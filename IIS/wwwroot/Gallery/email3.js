...
parent.right.document.writeln ("Please Select option<br><a href='javascript:parent.e_mail(1);'>Main Thumbs</a><br><a href='javascript:parent.e_mail(2);'>Main And Sub Thumbs</a><br><a href='javascript:parent.e_mail(3);'>Large Main 640 X 480</a><br><a href=\"javascript:parent.left.location.replace('Colors_Email.asp');\">Add Colors</a>");
parent.right.document.writeln ("</body></html>");
...
function page()
{
parent.rightB.document.location.replace ("email_right.html");
}
...
//parent.rightB.document.write("<html><head>");
//parent.rightB.document.writeln("<META HTTP-EQUIV=\"Pragma\" CONTENT=\"no-store\"><META HTTP-EQUIV=\"Expires\" CONTENT=\"-1\">");
//parent.rightB.document.write("<title>Content</title></head>" + defaultstyle);
parent.rightB.document.write(defaultstyle + "<body   background=\"images/creamGradient.jpg\" style=\"background-repeat:repeat-x; background-attachment:fixed\" topmargin=\"0\" leftmargin=\"4\" rightmargin=\"4\" bottommargin=\"0\">");
parent.rightB.document.write("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"115\">");
Refresh();
parent.rightB.document.write("</Table>");
//</body></html>");
...
function e_mail_option()
{
	win = loadWin(200,200,"Pre - Email Options",false,false,false);
	win.document.writeln(defaultstyle);
	win.document.writeln("Please Select option<br><a href='javascript:parent.e_mail(1);'>Main Thumbs</a><br><a href='javascript:parent.e_mail(2);'>Main And Sub Thumbs</a><br><a href='javascript:parent.e_mail(3);'>Large Main 640 X 480</a>");
	window.document.write ("</Body></Html>");
	window.document.close();
}

function e_mail(option)
{
	
	var which_url="";
	ok= confirm("Send e-mail with hyperlink click yes\nSend e-mail with content click no.");
	if (ok)
	{which_url="http://excab.dyndns.biz/";
	}
	
	str="";

	for(pos = 0; pos < count;pos+=2)
	{if(content[pos].indexOf("Color_") != -1)
	{
	str+= "&C=" + content[pos].substring(6,content[pos].length);
...
window.open (which_url+"creat_email" + option + ".asp?I=-1" + str, "", "toolbar=yes,menubar," + "width=800,height=600,Left=" + ((screen.Width / 2) - (800 / 2)) + ",Top=" + ((screen.Height / 2) - (600 / 2)) + ",scrollbars=yes");
...
function pre_view()
{
	...
	win.document.writeln(defaultstyle);
	win.document.writeln("<frameset framespacing='0' frameborder='0' rows='270'><frameset framespacing='0' frameborder='0' cols='300,*'><frame name='top' src='email_options.htm' scrolling='no'><frame name='TLayout' scrolling='no' marginwidth='0' marginheight='0'></frameset>");
