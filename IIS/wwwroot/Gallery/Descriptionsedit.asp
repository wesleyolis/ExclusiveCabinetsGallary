...
End If
%>
<form name="fDescriptionsedit" id="fDescriptionsedit" action="Descriptionsedit.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
<input type="hidden" name="a_edit" value="U">
<table class="ewTable">
<input type="hidden" id="x_Description" name="x_Description" value="<%= x_Description %>">
	<tr id="r_Name">
