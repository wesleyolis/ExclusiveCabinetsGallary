...
Image.ReadFile Server.MapPath("temp") & "/Color_" & Session("FileName")
...
Image.WriteFile Server.MapPath("orig") & "/Color_" & Request.QueryString("Key") & ".jpg"
...
Image.WriteFile  Server.MapPath("thumbs") & "\Color_" & Request.QueryString("Key") & ".jpg"

Image.Delete Server.MapPath("temp") & "\Color_" & Session("FileName")
...
Image.TextSize = 10
Image.TextBold = true
Image.Text image.width - 155, image.height -15, "www.ExclusiveCabinets.co.za"
Image.Text image.width - 110, image.height -28, "Tel: 27-21-9053770"
Image.TextSize = 12
Image.Text image.width-13, image.height -30,  "©"
