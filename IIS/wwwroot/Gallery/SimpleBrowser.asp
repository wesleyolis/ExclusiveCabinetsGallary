...
If rsi.eof Then
%><a href="../../welcome.htm">Home</a>&nbsp;&nbsp;| &nbsp;<a href="../index.html">Gallery</a><br><font color="#DE4010" size="4"><b>No Results Found</b></font>
<%
Else%>
<tr height="10px"><td></td></tr>
<tr><td align="center"><a href="../../welcome.htm">Home</a> &nbsp;|&nbsp;&nbsp;<a href="../index.html">Gallery</a><br>
<%
if Not (Request.QueryString("Des").Count > 0 And Request.QueryString("Range").Count > 0)  Then
if Request.QueryString("Des").Count > 0  Then
