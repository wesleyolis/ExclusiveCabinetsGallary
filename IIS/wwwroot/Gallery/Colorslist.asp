...
%>
<p><span class="aspmaker">TABLE: Colors
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Colorslist.asp?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="Colorslist.asp?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="Colorslist.asp?export=csv">Export to CSV</a>
<% End If %>
</span></p>
<% If sExport = "" Then %>
...
Color
<% Else %>
	<a href="Colorslist.asp?order=<%= Server.URLEncode("Color") %>">Color<% If Session(ewSessionTblSort & "_x_Color") = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Session(ewSessionTblSort & "_x_Color") = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></a>
<% End If %>
		</span></td>
		<td valign="top"><span>
<% If sExport <> "" Then %>
Name
<% Else %>
	<a href="Colorslist.asp?order=<%= Server.URLEncode("Name") %>">Name<% If Session(ewSessionTblSort & "_x_Name") = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Session(ewSessionTblSort & "_x_Name") = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></a>
<% End If %>
		</span></td>
<% If sExport = "" Then %>
<td>&nbsp;</td>
...
%>
	...
	<tr<%=sItemRowClass%><%=sListTrJs%>>
		<!-- Color -->
		<td><span>
<img src="thumbs/Color_<%= x_Color %>.jpg" width="100px" height="100px" Border=0>
</span></td>
		<!-- Name -->
		<td><span>
...
<% If sExport = "" Then %>
<td><span class="aspmaker"><a href="<% If Not IsNull(x_Color) Then Response.Write "Colorsedit.asp?Color=" & Server.URLEncode(x_Color) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Edit</a></span></td>
<td><span class="aspmaker"><a href="<% If Not IsNull(x_Color) Then Response.Write "Colorsadd.asp?Color=" & Server.URLEncode(x_Color) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Copy</a></span></td>
<td><span class="aspmaker"><a href="<% If Not IsNull(x_Color) Then Response.Write "Colorsdelete.asp?Color=" & Server.URLEncode(x_Color) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Delete</a></span></td>
<td><span class="aspmaker"><a href="<% If Not IsNull(x_Color) Then Response.Write "Imagescolor.asp?Key=" & Server.URLEncode(x_Color) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Image</a></span></td>
