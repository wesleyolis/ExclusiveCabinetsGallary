...
If x_Color = "" Or IsNull(x_Color) Then
	bCopy = False
End If
...
<p><span class="aspmaker">Add to TABLE: Colors<br><br><a href="Colorslist.asp">Back to List</a></span></p>
<%
...
End If
%>
<form name="fColorsadd" id="fColorsadd" action="Colorsadd.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
Sub Recordset_Inserted(rsnew)
	...
	sKey = sKey & rsnew.Fields("Color")
	x_Color = rsnew.Fields("Color")
End Sub
%>
