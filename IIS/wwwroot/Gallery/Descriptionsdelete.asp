...
If x_Description <> "" Then
	If Not IsNumeric(x_Description) Then
		Response.Redirect "Descriptionslist.asp" ' prevent sql injection
	End If
	If sKey <> "" Then sKey = sKey & ","
	sKey = sKey & x_Description
Else
	bSingleDelete = False
End If
...
Do While i <= UBound(arRecKey)
	...
	' Build the SQL
	sDbWhere = sDbWhere & "[Description]=" & AdjustSql(sRecKey) & " AND "
