...
If InStr(ip,"127.0.0.1")>0 Or InStr(ip,"192.168.1.")>0 Then
...
<link rel="stylesheet" href="live/gallery.css" type="text/css">
<style>
 .udot {border-bottom-style: dashed; border-bottom-width: 1px; padding: 2px; }
 .t1{font-size:11pt;border: 2px solid #cc907e; padding: 0}
</style>
<body background="live/images/creamGradient.jpg" style="background-repeat:repeat-x; background-attachment:fixed"  topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">


<table border="0" width="100%" height="95%" cellspacing="0" cellpadding="0">
<tr>
<td align="center" valign="top">
<table border="0" width="100%" height="100%" cellspacing="0" cellpadding="0"><tr><td width="30%"></td><td width="40%" align="center"><img border="0" src="live/images/logo2.JPG" width="315" height="211"></td><td width ="30%" align="right" valign="top">
...
{
parent.document.location = ("live/SimpleBrowser.asp");
}
else
{
...
parent.document.location = ("live/SimpleBrowser.asp?" + url + "");
}
...
<tr><td colspan="2" align="right"><font size="3">
	<a href="live/Color_Ranges/Colors.asp">All Board Colours</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font><input onclick="goto()" type="button" value="Filter"></td></tr>
</Table>
</Form>
...
<tr height="193px"><td>
	...
	<tr>
		<td>
		<img border="0" src="live/images/email_footer_span.JPG" width="100%" height="193"></td>
		<td width="752">
		<img border="0" src="live/images/email%20footer.JPG" width="752" height="193"></td>
		<td>
		<img border="0" src="live/images/email_footer_span.JPG" width="100%" height="193"></td>
	</tr>
	</table>
