...
parent.right.document.writeln ("Please Select option<br><a href='javascript:parent.e_mail(1);'>Main Thumbs</a><br><a href='javascript:parent.e_mail(2);'>Main And Sub Thumbs</a><br><a href='javascript:parent.e_mail(3);'>Large Main 640 X 480</a>");
...
window.open ("creat_email" + option + ".asp?I=-1" + str, "", "toolbar=yes,menubar," + "width=800,height=600,Left=" + ((screen.Width / 2) - (800 / 2)) + ",Top=" + ((screen.Height / 2) - (600 / 2)) + ",scrollbars=yes");
