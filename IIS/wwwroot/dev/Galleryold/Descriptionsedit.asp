...
End If
If sKey = "" Or IsNull(sKey) Then Response.Redirect "Descriptionslist.asp"
...
<p><span class="aspmaker">Edit TABLE: Descriptions<br><br><a href="Descriptionslist.asp">Back to List</a></span></p>
<form name="Descriptionsedit" id="Descriptionsedit" action="Descriptionsedit.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<% Response.Write x_Description %><input type="hidden" name="x_Description" value="<%= x_Description %>">
</span></td>
	</tr>
	<tr>
