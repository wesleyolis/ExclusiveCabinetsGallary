...
<tr>  
<% End If %>  
<td width="66" <td valign="top" <%=sItemRowClass%>><span class="aspmaker">
...
<a href="<% If Not IsNull(sKey) Then Response.Write "Colorsadd.asp?key=" & Server.URLEncode(sKey) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Copy</a></span></td>
