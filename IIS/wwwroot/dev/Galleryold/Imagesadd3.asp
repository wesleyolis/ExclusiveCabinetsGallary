...
&nbsp;&nbsp;&nbsp;
<!--webbot bot="Validation" s-data-type="String" b-allow-letters="TRUE" b-allow-digits="TRUE" i-maximum-length="16" -->
<input <%If Code = 3 Then%>title="This Code exist all ready" style="background-color: #FF6666"<%End IF%>  class="input" type="text" name="x_Code" id="x_Code" size="30" maxlength="16" value="<%= Server.HTMLEncode(x_Code&"") %>" tabindex="1">
</td>
...
Function AddData()
	...
	sSql = "SELECT * FROM [Images]"
	sSql = sSql & " WHERE 0 = 1 And Code='" & sTmp & "'"
	sGroupBy = ""
	sHaving = ""
	sOrderBy = ""
	If sGroupBy <> "" Then
