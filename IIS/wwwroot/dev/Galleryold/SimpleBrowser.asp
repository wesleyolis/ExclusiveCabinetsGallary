...
If rsi.eof Then
%><a href="../index.html">Gallery Home</a><br><font color="#DE4010" size="4"><b>No Results Found</b></font>
<%
Else%>
<tr height="10px"><td></td></tr>
<tr><td align="center"><a href="../index.html">Gallery Home</a><br>
<%
if Not (Request.QueryString("Des").Count > 0 And Request.QueryString("Range").Count > 0)  Then
if Request.QueryString("Des").Count > 0  Then
...
<a href="images/html/image.asp@I=<%=rsi.Fields("Image")%>&Type.html"><img border="1" src="images/thumbs/image.asp@I=<%=rsi.Fields("Image")%>&Type.jpg"></a></td>
</tr>
<tr><td colspan="2"><b>Description:</b> <%=rsi.Fields("Descriptions.Name")%></td></tr>
<tr><td colspan="2"><b>Dimensions: </b><%=rsi.Fields("Width")%> <b>X</b> <%=rsi.Fields("Height")%><b>X</b><%=rsi.Fields("Depth")%><font size="2"> in mm</font></td></tr>
...
<tr><td width="162" colspan="2"><b>Client Ref:</b>&nbsp;&nbsp;&nbsp; <%=rsi.Fields("Client")%>&nbsp; </td></tr>
<tr><td  class="udot" height="30"><b><a href="javascript:d('<%=rsi.Fields("Image")%>');">Info - click here</a></b></td><td  class="udot" height="30" align="right"></td></tr>
