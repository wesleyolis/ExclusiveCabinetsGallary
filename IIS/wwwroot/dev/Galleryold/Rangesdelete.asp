...
If UBound(arRecKey) = -1 Then Response.Redirect "Rangeslist.asp"
For Each sRecKey In arRecKey
	...
	' Build the SQL
	sDbWhere = sDbWhere & "([Range]=" & AdjustSql(sRecKey) & ") OR "
Next
...
<p><span class="aspmaker">Delete from TABLE: Ranges<br><br><a href="Rangeslist.asp">Back to List</a></span></p>
<form action="Rangesdelete.asp" method="post">
<p>
