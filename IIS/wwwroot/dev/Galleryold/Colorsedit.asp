...
<form name="Colorsedit" id="Colorsedit" action="Colorsedit.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
<% Response.Write x_Color %><input type="hidden" name="x_Color" value="<%= x_Color %>">
</span></td>
	</tr>
	<tr>
