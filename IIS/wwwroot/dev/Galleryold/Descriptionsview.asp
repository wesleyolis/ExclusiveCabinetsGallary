...
<a href="<%= "Descriptionsedit.asp?key=" & Server.URLEncode(sKey) %>">Edit</a>&nbsp;
<a href="<%= "Descriptionsadd.asp?key=" & Server.URLEncode(sKey) %>">Copy</a>&nbsp;
<a href="<%= "Descriptionsdelete.asp?key=" & Server.URLEncode(sKey) %>">Delete</a>&nbsp;
</span></p>
<p>
<form>
