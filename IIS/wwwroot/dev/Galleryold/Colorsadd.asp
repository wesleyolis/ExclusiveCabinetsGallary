...
<form name="Colorsadd" id="Colorsadd" action="Colorsadd.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
Function AddData()
	...
	sSqlChk = "SELECT * FROM [Colors] WHERE [Name] = '" & AdjustSql(sTmp) & "'"
