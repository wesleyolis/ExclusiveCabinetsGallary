...
<form name="Rangesadd" id="Rangesadd" action="Rangesadd.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
Function AddData()
	...
	sSqlChk = "SELECT * FROM [Ranges] WHERE [Name] = '" & AdjustSql(sTmp) & "'"
