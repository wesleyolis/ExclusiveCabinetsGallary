...
<table border="0" width="100%" height="100%" cellspacing="0" cellpadding="0"><tr>
	<td width="31%" rowspan="2"></td><td width="38%" align="center" rowspan="2"><img border="0" src="images/logo2.JPG" width="315" height="211"></td>
	<td width ="31%" align="right" valign="top" height="100" colspan="2">


<Form action="login.asp" method="post">
<table border="1" bordercolor="#CC907E" cellpadding="2" cellspacing="0" width="207"><%if Not Session("Admin") = True THEN%>
<tr><td width="68">Username</td><td width="125"><input type="text" name="user" id="user" size="16" maxlength="16"></td></tr>
<tr><td width="68">Password</td><td width="125">
...
<%END IF%>
	...
	<tr><td width ="26%" align="right" valign="bottom">


<Form action="Dirbrowser.asp" method="get">
<%If Request.QueryString("Email")  = "true" Then%><input type="hidden" name="Email0" value="true"><%END IF%>
<table border="1" bordercolor="#CC907E" cellpadding="3" cellspacing="0" id="table1" width="206">
<tr><td width="65">Ulti Sales</td><td width="123"><input type="text" name="Ulti" id="Ulti" size="16" maxlength="16"></td></tr>
<tr><td width="65">Client Ref</td><td width="123"><input type="text" name="Client" id="Client" size="16" maxlength="16"></td></tr>
<tr><td colspan="2" align="right"><input type="submit" value="Search"></td></tr>
</Table>
</Form></td><td width ="47" align="center" valign="bottom">
...
&nbsp;</td>
<td width="20%" align="center"><A href="DirBrowser.asp?d=-1<%If Request.QueryString("Email") = "true" Then%>&Email=true<%END IF%>">Directory Browser</a><br><br>
<%If Not Request.QueryString("Email") = "true" Then%>
<A href="gallary_browser.htm">Email Browser</a><br><br>
<%END IF%>
<%if Session("Admin") = True THEN%><a href="admin.html">Edit Selection Categories</a><%END IF%>
</td>
