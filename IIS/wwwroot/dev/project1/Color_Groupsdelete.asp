...
If x_Index <> "" Then
	If Not IsNumeric(x_Index) Then
		Response.Redirect "Color_Groupslist.asp" ' prevent sql injection
	End If
...
End If
If sKey = "" Or IsNull(sKey) Then Response.Redirect "Color_Groupslist.asp"
arRecKey = Split(sKey&"", ",")
i = 0
...
<p><span class="aspmaker">Delete from TABLE: Color Groups<br><br><a href="Color_Groupslist.asp">Back to List</a></span></p>
<%
...
End If
%>
<form action="Color_Groupsdelete.asp" method="post">
<p>
