...
<% If sExport = "" Then %>
&nbsp;&nbsp;<a href="Rangeslist.asp?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="Rangeslist.asp?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="Rangeslist.asp?export=csv">Export to CSV</a>
<% End If %>
</span></p>
<% If sExport = "" Then %>
...
Name
<% Else %>
	<a href="Rangeslist.asp?order=<%= Server.URLEncode("Name") %>">Name<% If Session(ewSessionTblSort & "_x_Name") = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Session(ewSessionTblSort & "_x_Name") = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></a>
<% End If %>
		</span></td>
<% If sExport = "" Then %>
<td>&nbsp;</td>
...
<% If sExport = "" Then %>
<td><span class="aspmaker"><a href="<% If Not IsNull(x_Range) Then Response.Write "Rangesedit.asp?Range=" & Server.URLEncode(x_Range) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Edit</a></span></td>
<td><span class="aspmaker"><a href="<% If Not IsNull(x_Range) Then Response.Write "Rangesadd.asp?Range=" & Server.URLEncode(x_Range) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Copy</a></span></td>
<td><span class="aspmaker"><a href="<% If Not IsNull(x_Range) Then Response.Write "Rangesdelete.asp?Range=" & Server.URLEncode(x_Range) Else Response.Write "javascript:alert('Invalid Record! Key is null');" End If %>">Delete</a></span></td>
<% End If %>
	</tr>
<%
	End If
...
Sub ResetSearch()
	...
	Session(ewSessionTblAdvSrch & "_x_Sync") = ""
...
Sub RestoreSearch()
	...
	x_Sync = Session(ewSessionTblAdvSrch & "_x_Sync")
