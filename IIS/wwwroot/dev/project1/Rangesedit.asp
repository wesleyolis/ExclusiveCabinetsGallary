...
End If
%>
<form name="fRangesedit" id="fRangesedit" action="Rangesedit.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
<input type="hidden" name="a_edit" value="U">
<table class="ewTable">
<input type="hidden" id="x_Range" name="x_Range" value="<%= x_Range %>">
	<tr id="r_Name">
