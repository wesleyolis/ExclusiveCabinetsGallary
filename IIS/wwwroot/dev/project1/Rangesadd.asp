...
If x_Range = "" Or IsNull(x_Range) Then
	bCopy = False
End If
...
<p><span class="aspmaker">Add to TABLE: Ranges<br><br><a href="Rangeslist.asp">Back to List</a></span></p>
<%
...
End If
%>
<form name="fRangesadd" id="fRangesadd" action="Rangesadd.asp" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
Sub Recordset_Inserted(rsnew)
	...
	sKey = sKey & rsnew.Fields("Range")
	x_Range = rsnew.Fields("Range")
End Sub
%>
