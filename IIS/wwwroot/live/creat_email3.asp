...
below doesn't apply to your quotation.</font></b><table border="0" cellpadding="0" cellspacing="0">
<tr><td>
<%
Rows = 1
RCount = 0
...
<a href="images/html/image.asp?I=<%=rsi.Fields("Image")%>"><img border="2" src="getimage.asp?I=<%=rsi.Fields("Image")%>&Resample=true&Quality=80&Width=640&Height=480"></a></td>
</tr><tr>
...
<td height="22" width="106"><b>G.C:</b> <%=rsi.Fields("Image")%></td></tr>
</table>
