...
Dim rs,coloms,colom
	...
	path = Server.MapPath("../../Gallery/thumbs")
...
and availability<font size="5">.<b><br></b></font></p>
...
<tr><td width="190" height="200" align="center"><%
		...
		%><a name="jump<%=rs("Color")%>" href="../images/large/image.asp?I=Color_<%=rs("Color")%>&Resample=True"><img border="0" src="thumbs.asp?I=<%=rs("Color")%>"></a><%
	Else
