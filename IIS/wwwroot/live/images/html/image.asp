...
Dim rs,rs2, Img, conn, sql
Img = Request.QueryString("I")
conn.Open xDb_Conn_Str

Set rs2 = Conn.Execute("SELECT Image_Groups.Group FROM Image_Groups WHERE ((Image_Groups.Image)=" & Img & ") ORDER BY Image_Groups.Group;")
...
<table class="t1" cellSpacing="0" cellPadding="2" width="410" bgColor="#E4CAC0" border="0" id="table2">
	<tr>
		...
		<%=rs.Fields("Descriptions.Name")%>&nbsp;&nbsp;&nbsp;(<a href="../../SimpleBrowser.asp?Des=<%=rs.Fields("Description")%>">All Items</a>)</font></td>
	</tr>
	<tr>
	...
	<tr>
		...
		&nbsp;&nbsp;&nbsp;&nbsp; (<a href="../../SimpleBrowser.asp?Range=<%=rs.Fields("Range")%>&Des=<%=rs.Fields("Description")%>">In Current 
		Range</a>)</font></td>
	</tr>
	<tr>
		<td colSpan="2" height="25"><b><font size="3">Colour:</font></b><font size="3">&nbsp; 
		<%=rs.Fields("Colors.Name")%>&nbsp;&nbsp;&nbsp;&nbsp; (<a href="../../Color_Ranges/Available_Colors.asp?<%=Link%>">Available 
		Colours</a>)&nbsp;&nbsp;(<a href="../../Color_Ranges/Colors.asp">ALL</a>)</font></td>
	</tr>
		<tr>
	...
	<tr>
		<td width="406" colSpan="2" height="25"><b><font size="3">Gallery Code:</font></b><font size="3">&nbsp;&nbsp;<%=rs.Fields("Image")%>
		</font></td>
	</tr>
	</table>
<p align="left">&nbsp;
<a href="../../../../welcome.htm">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../../../welcome.htm">Gallery</a>
</p>
<p align="center"><%=rs.Fields("Info")%></p>
...
Set rs = Conn.Execute(sql)
%>
<tr><td align="center"><img border="2" src="../large/image.asp?I=<%=Request.QueryString("I")%>"></td></tr>
<tr><td height="31">&nbsp;</td></tr>
<%while Not rs.eof	%>	
<tr><td align="center">
<img border="2" src="../large/image.asp?I=<%=Img%>_<%=rs(0)%>"></td></tr>
